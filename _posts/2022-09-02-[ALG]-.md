...
- 
	...
	![5](/assets/img/2022-09-02-[ALG]-.md/5.png)
...
- Why is the iterative version more efficient?
	- 
		...
		![6](/assets/img/2022-09-02-[ALG]-.md/6.png)
...
- Linear versus exponential
	- 
		...
		![7](/assets/img/2022-09-02-[ALG]-.md/7.png)
...
![8](/assets/img/2022-09-02-[ALG]-.md/8.png)
...
- Ex:
	...
	- 
		...
		![9](/assets/img/2022-09-02-[ALG]-.md/9.png)
...
- 
	...
	![10](/assets/img/2022-09-02-[ALG]-.md/10.png)
...
- 현실적으루 n이 작을 때에는 그렇게 큰 지장이 없지만, n이 점차 커질 때 log, linear는 잘 버티는 데에 반해 exp, factorial
	...
	![11](/assets/img/2022-09-02-[ALG]-.md/11.png)

	- logarithmic, linear, n log n, quadratic, cubic << exp << factorial

![12](/assets/img/2022-09-02-[ALG]-.md/12.png)
...
- Example
	...
	- 이 안에 모든 존재하는 subsequence 중에 합을 가장 크게 하는 subsequence를 찾아라.
		...
		![13](/assets/img/2022-09-02-[ALG]-.md/13.png)
...
- a의 최대값을 구하는 문제이다.
	...
	![14](/assets/img/2022-09-02-[ALG]-.md/14.png)
...
- 이 문제는 최대 부분 수열의 합을 구하는 것이지만, 앞으로 소개할 알고리즘을 조금만 수정하면 최대 부분 수열도 쉽게 구할 수 있다.
	...
	![15](/assets/img/2022-09-02-[ALG]-.md/15.png)
	...
	![16](/assets/img/2022-09-02-[ALG]-.md/16.png)
	...
	![17](/assets/img/2022-09-02-[ALG]-.md/17.png)
...
![18](/assets/img/2022-09-02-[ALG]-.md/18.png)
...
![19](/assets/img/2022-09-02-[ALG]-.md/19.png)


# MSS  3 : Divide n Conquer


![20](/assets/img/2022-09-02-[ALG]-.md/20.png)
...
- Strategy
	...
	- Divide and Conquer
		...
		![21](/assets/img/2022-09-02-[ALG]-.md/21.png)
...
- i번째 원소로 끝나는 가장 합이 큰 subsequence가 얘라면, 다른 나머지를 분리했을 때 i-1로 끝나는 subsequence이다.
	...
	![22](/assets/img/2022-09-02-[ALG]-.md/22.png)
...
- Time Complexity : $O(n^4)$
	...
	![23](/assets/img/2022-09-02-[ALG]-.md/23.png)
...
- Idea
	...
	- 그렇게 하기 위하여, ...
		...
		![24](/assets/img/2022-09-02-[ALG]-.md/24.png)
...
- Proof by Induction
	...
	![25](/assets/img/2022-09-02-[ALG]-.md/25.png)
